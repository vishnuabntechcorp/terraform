root@ip-172-31-11-47:/home/ubuntu/terratest-scripts# cat main.tf
provider "aws" {
...
variable "vpc_id" {
  ...
  type        = string
  default     = "vpc-005efedd4249a6bbc"
}

variable "subnets" {
  description = "A list of subnets for the ALB and EC2 instances"
  type        = list(string)
  default     = ["subnet-029d567b2af2adfff", "subnet-0bbe2574f9c56f4b6"]  # Replace with default subnets
}

variable "domain_name" {
  description = "The domain name for Route 53"
  type        = string
  default     = "devopsteam.com"
}

variable "hosted_zone_id" {
  description = "The Route 53 Hosted Zone ID"
  type        = string
  default     = "Z0689564K9S7SA449N6Z"  # Replace with a default Hosted Zone ID
}
...
resource "aws_launch_template" "web_lt" {
  ...
  image_id      = "ami-0e86e20dae9224db8"  # Replace with your preferred AMI ID
